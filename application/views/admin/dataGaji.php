    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <form class="form-inline">
                ...
                <?php if (count($gaji) > 0) { ?>
                    <a href="<?= base_url('admin/dataPenggajian/cetakGaji?bulan=' . $bulan), '&tahun=' . $tahun ?>" class="btn btn-success mb-2 ml-2"> <i class="fas fa-print"></i></i> Cetak Daftar Gaji</a>
                <?php } else { ?>
                    <button type="button" class="btn btn-success mb-2 ml-3" data-toggle="modal" data-target="#exampleModal">
                        <i class="fas fa-print"></i></i> Cetak Daftar Gaji
                    </button>
                <?php } ?>
            ...
            <table class="table table-bordered table-striped">
                ...
                foreach ($gaji as $g) : ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">Rp. <?= number_format($g->gaji_pokok + $g->tj_transport + $g->uang_makan - $potongan, 0, ',', '.') ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Data Gaji masih kosong, silahkan input absensi terlebih dahulu pada bulan dah tahun yang Anda pilih
            </div>
